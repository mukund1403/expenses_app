...
func TestIntegration_LLMTransactionExtraction(t *testing.T) {
	...
	tests := []struct {
		...
		// },
		{
			...
			[BUY NOW ](https://fcz5e.r.ag.d.sendibm3.com/mk/cl/f/sh/WCPzyXJTZ7nT7wUAI9aXGx3KXDuktd72/2uzEtt6xWGMx)   I     [PROMOTIONS](https://fcz5e.r.ag.d.sendibm3.com/mk/cl/f/sh/WCPzyXJTZ6uvfgzJnXEosjwmXhgw7ho8/wZbumrDbEkjZ)    I    [TRAVELS](https://fcz5e.r.ag.d.sendibm3.com/mk/cl/f/sh/WCPzyXJTZ833G0uh0KXsoRMuongzP2LI/s_97LxZNmgH-)
			
			For any feedback, contact us at [customer@thesoupspoon.com.](mailto:customer@thesoupspoon.com)
			You have received this email because you are a [Souperholic member.](https://fcz5e.r.ag.d.sendibm3.com/mk/cl/f/sh/28xHLtxYQ4yaodCgmR1zBfbSx1Mkd8dqlU/hImnymC2Q_5w/souperholic-main/souperholic-login/)
			To unsubscribe from this mailing list, please click [here.](https://fcz5e.r.ag.d.sendibm3.com/mk/un/v2/sh/WCPxRrWByckTj8gaJ2Q4Q0qp2D9dBlgO/hdNsimsh1O4l)
			`,
			check: func(t *testing.T, tx models.PromptResponse) {
				if tx.IsTransaction == true {
					t.Errorf("expected not a transaction, got transaction")
				}
			},
		},
	}
